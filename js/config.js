...
export const CONFIG = {
    ...
    steps: [
      {
        ...
        text: 'Хозяин, я только родился и уже голоден и хочу пить. Накорми и напои меня, покажу как.',
      ...
      },
      {
        ...
        cardPlacement: 'top',
        text: 'Жми сюда для фото-кормления. Это наш главный ритуал: фото -> совет -> покормить.',
        buttonText: 'Открываю',
      },
      {
        id: 'feed_source',
      ...
      },
      {
        ...
        cardPlacement: 'top',
        dim: 'light',
        text: 'Я дал факт и совет по питанию. Теперь жми "Покормить" и смотри, как растут сытость и жажда.',
  ...
  foodPhoto: {
    ...
    nutritionCoach: {
      factsById: {
        water: ['Даже 1-2% обезвоживания уже бьет по концентрации.'],
        tea: ['Зеленый и черный чай содержат полифенолы — это антиоксиданты.'],
        juice: ['Сок дает витамины, но клетчатки в нем меньше, чем во фрукте.'],
        milk: ['Молоко дает белок и кальций, особенно полезно после активности.'],
        apple: ['Яблоко богато пектином — он помогает мягко насыщаться.'],
        banana: ['Банан дает быстрые углеводы и калий для мышц.'],
        broccoli: ['Брокколи — источник витамина C и растительных соединений.'],
        fish: ['Рыба дает белок и омега-3, которые важны для мозга.'],
        eggs: ['Яйца содержат полноценный белок с хорошим аминокислотным профилем.'],
        coffee: ['Кофеин бодрит, но лучше не заменять им обычную воду.'],
        cola: ['Сладкая газировка быстро поднимает сахар и так же быстро роняет.'],
        burger: ['Фастфуд сытный, но часто дает избыток соли и насыщенных жиров.'],
      },
      factsByKind: {
        good: ['Хороший выбор: такая еда обычно дает сытость без резких скачков.'],
        neutral: ['Нейтрально: главное — держать баланс в течение дня.'],
        bad: ['Иногда можно, но лучше сочетать с водой и более простой едой.'],
      },
      fallbackFacts: ['Баланс проще держать, когда в дне есть и еда, и обычная вода.'],
      advice: {
        noDrinkYet: [
          'Совет: сегодня добавь воду, тогда колобок держит тонус ровнее.',
          'Совет: для баланса добей один напиток без сахара.',
        ],
        noFoodYet: [
          'Совет: теперь добавь нормальную еду, не только напитки.',
          'Совет: закрой день хоть одним нормальным приемом пищи.',
        ],
        badKind: [
          'Совет: после такого лучше добрать воду или фрукт для баланса.',
          'Совет: следующий скан сделай полегче — колобок скажет спасибо.',
        ],
        goodKind: [
          'Совет: отличный ход, держи такой темп и чередуй продукты.',
          'Совет: топ, добавь воды — и баланс почти идеальный.',
        ],
        default: [
          'Совет: разнообразие работает лучше, чем идеальная еда раз в неделю.',
          'Совет: держи баланс — еда + вода в течение дня.',
        ],
        patternWaterGap: [
          'Паттерн: за последние дни мало напитков. Добей сегодня 1-2 скана воды.',
          'Паттерн: у тебя перекос в еду без воды, добавь пару питьевых сканов.',
        ],
        patternBadOveruse: [
          'Паттерн: в последних сканах много сладкого/фаста. Следующий выбор сделай полегче.',
          'Паттерн: перекос в тяжёлую еду. Для баланса добери воду и что-то из good.',
        ],
        patternLowDiversity: [
          'Паттерн: повторяется один тип еды. Добавь разнообразие, колобку так лучше.',
          'Паттерн: мало разнообразия по продуктам. Попробуй другой тип в следующем скане.',
        ],
      },
    },
    effectsByKind: {
